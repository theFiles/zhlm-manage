...
<template>
    <div class="page">
        ...
        <table-search @search="search" @reset="reset" ref="tableSearch" v-model="searchForm">
            ...
            <form-item label="是否默认" name="is_default" type="select" list-type="yesOrNo"></form-item>
            <form-item label="标签" name="label"></form-item>
        </table-search>
        ...
        <data-table :url="$options.url"
            ...
            <el-table-column label="是否默认" prop="is_default" width="80">
                <template slot-scope="scope">{{ scope.row.is_default === 1 ? '是' : '否' }}</template>
            </el-table-column>
        ...
        <el-dialog v-if="!openNewPage"
            ...
            <ape-form ref="form" v-model="form">
                <form-item label="用户id" name="user_id" required></form-item>
                <form-item label="联系人" name="name" ></form-item>
                <form-item label="联系电话" name="phone" ></form-item>
                <form-item label="省份" name="province" ></form-item>
                <form-item label="城市" name="city" ></form-item>
...
<script>
    define(["vue", "listMixins"], function (Vue, listMixins) {
        return Vue.component("tablePage", {
            ...
            url: '/tuozhanbao/address/pageList.do',
            detailUrl: '/tuozhanbao/address/detail.do',
            saveUrl: '/tuozhanbao/address/save.do',
            deleteUrl: '/tuozhanbao/address/delete.do',
            deleteBatchUrl: '/tuozhanbao/address/deleteBatch.do',
            exportUrl: '/tuozhanbao/address/list.do',
