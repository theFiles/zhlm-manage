...
<template>
    <div class="page">
        ...
        <data-table :url="$options.url"
            ...
            <!--<el-table-column label="内容" name="content" type="editor" ></el-table-column>-->
...
<script>
    define(["vue", "listMixins"], function (Vue, listMixins) {
        return Vue.component("tablePage", {
            url: '/tuozhanbao/hotHeadlines/pageList.do',
            detailUrl: '/tuozhanbao/hotHeadlines/detail.do',
            saveUrl: '/tuozhanbao/hotHeadlines/save.do',
            deleteUrl: '/tuozhanbao/hotHeadlines/delete.do',
            deleteBatchUrl: '/tuozhanbao/hotHeadlines/deleteBatch.do',
            exportUrl: '/tuozhanbao/hotHeadlines/list.do',
