...
<script>
    define(["vue", "listMixins"], function (Vue, listMixins) {
        return Vue.component("tablePage", {
            url: '/tuozhanbao/advert/pageList.do',
            detailUrl: '/tuozhanbao/advert/detail.do',
            saveUrl: '/tuozhanbao/advert/save.do',
            deleteUrl: '/tuozhanbao/advert/delete.do',
            deleteBatchUrl: '/tuozhanbao/advert/deleteBatch.do',
            exportUrl: '/tuozhanbao/advert/list.do',
