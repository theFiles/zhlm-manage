...
<script>
  define(["vue", "listMixins"], function (Vue, listMixins) {
    return Vue.component("tablePage", {
      ...
      idKey: 'configid',
      url: 'sys/sysconfig/list.do',
      detailUrl: 'sys/sysconfig/detail.do',
      saveUrl: 'sys/sysconfig/save.do',
      deleteUrl: 'sys/sysconfig/delete.do',
      ...
      methods: {
        detailLoadSuccessCallback (result) {
          this.form = result.result.sysconfig;
          this.$nextTick(() => {
